...
function U.button(parent,name,value,x,y,w,h,fn,accent)
 local b=Instance.new("TextButton");b.Name=name;b.Position=UDim2.fromOffset(x,y);b.Size=UDim2.fromOffset(w,h);b.BackgroundColor3=accent and U.colors.orange or U.colors.cream;b.Text=value;b.TextColor3=U.colors.ink;b.TextSize=22;b.Font=Enum.Font.GothamBold;b.TextWrapped=true;b.BorderSizePixel=0;b.AutoButtonColor=true;b.Active=true;b.Parent=parent;b:SetAttribute("Primary",accent==true);U.corner(b,12);U.outline(b,2)
...
function U.enabled(b,value)
 ...
 b.TextColor3=active and U.colors.ink or U.colors.muted
